    ...
    <div className="mt-20 md:px-16 drawer drawer-mobile">
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 overflow-y-auto w-60 bg-base-100 text-base-content">
          ...
          <li>
            {!admin && <Link to="/dashboard/add-review">Add a review</Link>}
          </li>
          <li>{admin && <Link to="/dashboard/make-admin">Make Admin</Link>}</li>
          <li>
            {admin && <Link to="/dashboard/add-product">Add Product</Link>}
          </li>
          <li>
